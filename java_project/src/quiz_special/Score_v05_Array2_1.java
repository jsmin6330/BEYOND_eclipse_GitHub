...
public class Score_v05_Array2_1 {
	public static void main(String[] args) {
		...
		for(int i = 0; i<num_person; i++) { 
			...
			}while(	(subject[i][0] < 0 || subject[i][0] > 100) || (subject[i][1] < 0 || subject[i][1] > 100) || (subject[i][2] < 0 || subject[i][2] > 100));
			subject[i][3] = subject[i][0] + subject[i][1] +subject[i][2];
